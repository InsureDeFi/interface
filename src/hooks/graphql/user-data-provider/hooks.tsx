...
export type LiquidityPositionQueryVariables = Exact<{
  account: Scalars['ID'];
}>;

export type LiquidityPositionQuery = {
  __typename?: 'Query';
  liquidityPosition?: { __typename?: 'LiquidityPosition'; shares: string } | null;
};
...
export type SnapshotsQuery = {
  __typename?: 'Query';
  liquidityPositionSnapshots: Array<{
    __typename?: 'LiquidityPositionSnapshot';
    shares: string;
...
export type EventsQuery = {
  __typename?: 'Query';
  deposits: Array<{ __typename?: 'Deposit'; assets: string; liquidityTokens: string; timestamp: string }>;
  withdraws: Array<{ __typename?: 'Withdraw'; assets: string; liquidityTokens: string; timestamp: string }>;
};
...
export type PolicyDataQuery = {
  ...
  policies: Array<{
    ...
    threshold: number;
    utilized: boolean;
    asset: { __typename?: 'Asset'; symbol: string };
  }>;
};

export const LiquidityPositionDocument = gql`
  query liquidityPosition($account: ID!) {
    liquidityPosition(id: $account) {
      shares
    }
  }
`;
...
/**
 * __useLiquidityPositionQuery__
 *
 * To run a query within a React component, call `useLiquidityPositionQuery` and pass it any options that fit your needs.
 * When your component renders, `useLiquidityPositionQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLiquidityPositionQuery({
 *   variables: {
 *      account: // value for 'account'
 *   },
 * });
 */
export function useLiquidityPositionQuery(
  baseOptions: Apollo.QueryHookOptions<LiquidityPositionQuery, LiquidityPositionQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<LiquidityPositionQuery, LiquidityPositionQueryVariables>(LiquidityPositionDocument, options);
}
export function useLiquidityPositionLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<LiquidityPositionQuery, LiquidityPositionQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<LiquidityPositionQuery, LiquidityPositionQueryVariables>(
    LiquidityPositionDocument,
    options
  );
}
export type LiquidityPositionQueryHookResult = ReturnType<typeof useLiquidityPositionQuery>;
export type LiquidityPositionLazyQueryHookResult = ReturnType<typeof useLiquidityPositionLazyQuery>;
export type LiquidityPositionQueryResult = Apollo.QueryResult<LiquidityPositionQuery, LiquidityPositionQueryVariables>;
...
export function useSnapshotsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<SnapshotsQuery, SnapshotsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
...
/**
 * __usePolicyDataQuery__
 *
 * To run a query within a React component, call `usePolicyDataQuery` and pass it any options that fit your needs.
 * When your component renders, `usePolicyDataQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = usePolicyDataQuery({
 *   variables: {
 *      account: // value for 'account'
 *   },
 * });
 */
export function usePolicyDataQuery(baseOptions: Apollo.QueryHookOptions<PolicyDataQuery, PolicyDataQueryVariables>) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<PolicyDataQuery, PolicyDataQueryVariables>(PolicyDataDocument, options);
}
export function usePolicyDataLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<PolicyDataQuery, PolicyDataQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<PolicyDataQuery, PolicyDataQueryVariables>(PolicyDataDocument, options);
}
export type PolicyDataQueryHookResult = ReturnType<typeof usePolicyDataQuery>;
export type PolicyDataLazyQueryHookResult = ReturnType<typeof usePolicyDataLazyQuery>;
export type PolicyDataQueryResult = Apollo.QueryResult<PolicyDataQuery, PolicyDataQueryVariables>;
